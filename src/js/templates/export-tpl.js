...
let export_tpl = `
  ...
  <div class="mdl-dialog__content">
    ...
    <p>Exporting will store your current work to the CRIM databse or to a file that you will be able to open and edit later.<br/>
       Your scores will remain open, but the relationships created will not be available until reloaded. Continue?</p>
  </div>
